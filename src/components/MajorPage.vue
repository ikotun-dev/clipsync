  ...
  <div class="bg-gray-950 min-h-screen ">
    ...
    <div style="height: auto; min-height: h-screen;" class="pb-20  lg:px-36  bg-gray-950">
      ...
      <div class="flex flex-col">
        ...
        <i></i>
        <div class="flex items-center mt-2 mx-6 lg:mx-20 bg-gray-600 rounded-md focus:bg-gray-700 h-auto cursor-pointer">
...
export default {
  ...
  methods: {
    ...
    connectWebSocket() {
      ...
      this.socket = new WebSocket(`wss://dropit-express.fly.dev/${this.sessionCode}?token=${token}`);
  ...
  mounted() {
    ...
    this.socket = new WebSocket(`wss://dropit-express.fly.dev/${this.sessionCode}?token=${Vuecookies.get('token')}`)
